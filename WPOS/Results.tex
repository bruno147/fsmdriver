...
All race results are logged into a file and the best configuration\toDo{CONCLUIR A FRASE}
...
The damage taken can be significantly reduced by implementing an enemy avoidance and overtaking behavior,\toDo{CONCLUIR FRASE}
